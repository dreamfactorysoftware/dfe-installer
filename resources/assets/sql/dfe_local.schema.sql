...
CREATE TABLE `instance_t` (
  ...
  `last_state_date`     DATETIME                NOT NULL   CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `start_date`          DATETIME                           DEFAULT NULL,
  `end_date`            DATETIME                           DEFAULT NULL,
  `terminate_date`      DATETIME                           DEFAULT NULL,
  `create_date`         DATETIME                NOT NULL   CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `lmod_date`           TIMESTAMP               NOT NULL   DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
