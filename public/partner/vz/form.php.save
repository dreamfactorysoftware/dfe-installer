...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="row navbar-title-row">
            <div class="col-md-2 col-sm-3 col-xs-3 align-left"><img src="images/verizon_left.png" alt></div>
            <div class="col-md-8 col-sm-6 col-xs-6 align-center"><h1 class="navbar-title">DreamFactory Hosted on Verizon
                    Cloud</h1></div>
            <div class="col-md-2 col-sm-3 col-xs-3 align-right"><img src="images/factory_right.png" alt></div>
        </div>
    </div>
</nav>
...
<div class="container-fluid">
    <div class="row" style="margin:0 auto;">
        <div class="col-md-6 col-sm-6 col-xs-6">
            <h3>Get RESTful With DreamFactory!</h3>
            ...
            <div style="margin: 15px auto;" class="align-center">
                <iframe seamless="seamless"
                        width="420"
                        height="315"
                        src="https://www.youtube.com/embed/8Y0uCaTw3jg"
                        align="center"
                        frameborder="0"
        ...
        <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <p>Sign up for a free developer sandbox environment and try <strong>DreamFactory hosted on Verizon
                    Cloud</strong>. You can
            ...
            <p style="font-size: 13px;">Already registered? <a href="https://dashboard.vz.dreamfactory.com/">Click
                    here to log in to DreamFactory Enterprise&trade; on Verizon.</a></p>
