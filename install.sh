...
## Customisations
export FACTER_NAVBAR_IMAGE_PATH=${NAVBAR_IMAGE_PATH}
export FACTER_NAVBAR_IMAGE=${NAVBAR_IMAGE}
export FACTER_LOGIN_SPLASH_IMAGE_PATH=${LOGIN_SPLASH_IMAGE_PATH}
export FACTER_LOGIN_SPLASH_IMAGE=${LOGIN_SPLASH_IMAGE}
export FACTER_CUSTOM_CSS_FILE_PATH=${CUSTOM_CSS_FILE_PATH}
export FACTER_CUSTOM_CSS_FILE=${CUSTOM_CSS_FILE}
