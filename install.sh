...
## Customisations
export FACTER_NAVBAR_IMAGE_SOURCE=${FACTER_NAVBAR_IMAGE_SOURCE}
export FACTER_NAVBAR_IMAGE_PATH=${FACTER_NAVBAR_IMAGE_PATH}
export FACTER_NAVBAR_IMAGE=${FACTER_NAVBAR_IMAGE}
export FACTER_LOGIN_SPLASH_IMAGE_SOURCE=${FACTER_LOGIN_SPLASH_IMAGE_SOURCE}
export FACTER_LOGIN_SPLASH_IMAGE_PATH=${FACTER_LOGIN_SPLASH_IMAGE_PATH}
export FACTER_LOGIN_SPLASH_IMAGE=${FACTER_LOGIN_SPLASH_IMAGE}
export FACTER_CUSTOM_CSS_FILE_SOURCE=${FACTER_CUSTOM_CSS_FILE_SOURCE}
export FACTER_CUSTOM_CSS_FILE_PATH=${FACTER_CUSTOM_CSS_FILE_PATH}
export FACTER_CUSTOM_CSS_FILE=${FACTER_CUSTOM_CSS_FILE}
